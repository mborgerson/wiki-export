...
DPSN-96-AP-1 should be the EU 240V one DPSN-96-AP is the US 120V one
...
A pc ATX supply needs a line pulled to GND to turn on the supply. The
xbox supply needs a voltage (3V3?) on it's power on line to turn the
supply on.

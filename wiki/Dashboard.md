...
Press , while playing audio CDs or soundtracks stored on the HDD to
display full-screen geiss-like music visualization. Or, press “INFO”
button on the DVD Playback Kit remote.

Only visible with DVD Playback Kit and Remote:

1.  Start playing a song using either the Xbox controller or playback
    kit remote.
2.  Press , on the controller or “INFO” on the remote to get the full
